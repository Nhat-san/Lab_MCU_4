...
/* Private defines -----------------------------------------------------------*/
#define DEBUG_LED_0_Pin GPIO_PIN_9
...
#define DEBUG_LED_3_Pin GPIO_PIN_12
#define DEBUG_LED_3_GPIO_Port GPIOA
#define ONESHOT_LED_Pin GPIO_PIN_13
#define ONESHOT_LED_GPIO_Port GPIOA
